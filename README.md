...
This driver is cross-platform and supports any Unix-like operating system running CUPS, including:

- **Linux**: Ubuntu, Debian, Fedora, Arch Linux, OpenSUSE, etc.
- **macOS**: Supported via standard CUPS integration.
- **BSD**: FreeBSD, OpenBSD.

*Note: While the CI/CD pipeline uses Debian Trixie for testing to access modern C++23 compilers (GCC 14), the driver itself will run perfectly on older or different distributions once compiled.*
